...
SDesdeFourierNumerico[t_]:=-NIntegrate[SFourier[\[Omega]]Cos[\[Omega] t],{\[Omega],-Infinito,Infinito},Method->{"LocalAdaptive","SingularityDepth"->20,"SingularityHandler"->Automatic},MaxRecursion->100,PrecisionGoal->10,WorkingPrecision->12,Exclusions->{SFourier[\[Omega]]^(-1)==0}]/(2 Pi)//Chop;
